...
public interface HttpConnection extends Connection {
    ...
    /**
     * 添加COOKIE，one by one，键值对
     * 
     * @param key
     * @param value
     */
    public abstract void appendCookie( String key, String value );
     ...
     */
    public abstract void buildArguments( String argumentsData );
     ...
     * @param cookiesData
     */
    public abstract void buildCookies( String cookiesData );
     ...
     * @param headerMap
     */
    public abstract void buildHeaders( Map<String, String> headerMap );
